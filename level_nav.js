...
(function () {
  ...
  function moveSelectionByLevel(dir) {
    ...
    /*
      В обычной структуре при простой навигации
      не перестраиваем всё дерево целиком.

      Иначе вместе с каждой стрелкой заново создаются
      описание и текстовые свойства всех объектов.
    */
    if (
      currentView === VIEW.SCHEMA &&
      typeof updateSchemaSelectionWithoutRender ===
        "function" &&
    ...
    /*
      В остальных отображениях сохраняем прежнее
      поведение, потому что там расположение узлов
