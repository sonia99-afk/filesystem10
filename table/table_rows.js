...

{
  ...
  function makeMarkCell(node) {
    ...
    /*
  Метка сохраняет охранные поля,
  но ширина колонки определяется
  по заголовку «Метка», а не по кружку.
*/
markTd.className =
  (
    "table-mark-cell " +
    "table-fixed-content-cell"
  );
